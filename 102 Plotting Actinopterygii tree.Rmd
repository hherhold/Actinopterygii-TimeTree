...
```{r}
## Load tree
actinopterygii_tree <- read.tree("output/Actinopterygii_species_with_order.nwk")
```

```{r}
## Load taxonomy data and map each tip to its order
taxon_order <- read.csv("output/Actinopterygii_genus_order_family_taxon.csv",
...
ggsave("output/Actinopterygii_circular_tree.png", plot = p, width = 20, height = 20, dpi = 300, limitsize = FALSE)
```
