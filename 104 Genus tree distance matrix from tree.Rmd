...
```{r}
# Load the genus tree
cleaned_fish_species_tree <- read.tree("output/Actinopterygii_species_with_order.nwk")
```
...
write.csv(species_dist_matrix, "output/Actinopterygii_tree_distance_matrix_R.csv", row.names = TRUE)
```
